...
Server side Routing and middleware, routing allows us to access different endpoints, while middleware takes care of the javascript functions for things like validation.

- [x] Describe Middleware?

A group of functions that get executed in the order they are recieved.

- [x] Describe a Resource?

 A Resource is accssible via a URI. Everything is a resource.

- [x] What can the API return to help clients know if a request was successful?

The api can return a status code.
